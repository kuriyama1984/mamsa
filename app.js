...
var db = mongoose.connect('mongodb://localhost/dragDropFiles');
//メモのスキーマを宣言。
...
//スキーマからモデルを生成。
var Memo = db.model('memo333',MemoSchema);
    ...
    socket.on('mongo',function(data){
        ...
        if (data && typeof data.text === 'string') {
            ...
            Memo.find(function(err,items){
                ...
                io.sockets.emit('mongo',{text:data.text, mongoTitle: items[0].title});
            });
